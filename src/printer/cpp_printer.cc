...
void CppPrinter::print_special_assignment(SpecialAssignment* expr) {
    print_binary_operator(":=", expr);
}

void CppPrinter::print_shift_right_logical_assignment(ShiftRightLogicalAssignment* expr) {
    print_binary_operator(">>>=", expr);
}

void CppPrinter::print_shift_right_arithmetic_assignment(ShiftRightArithmeticAssignment* expr) {
    print_binary_operator(">>=", expr);
}

void CppPrinter::print_shift_left_logical_assignment(ShiftLeftLogicalAssignment* expr) {
    print_binary_operator("<<=", expr);
}

void CppPrinter::print_times_assignment(TimesAssignment* expr) {
    print_binary_operator("*=", expr);
}

void CppPrinter::print_plus_assignment(PlusAssignment* expr) {
    print_binary_operator("+=", expr);
}

void CppPrinter::print_modulo_assignment(ModuloAssignment* expr) {
    print_binary_operator("%=", expr);
}

void CppPrinter::print_minus_assignment(MinusAssignment* expr) {
    print_binary_operator("-=", expr);
}

void CppPrinter::print_integer_division_assignment(IntegerDivisionAssignment* expr) {
    print_binary_operator("//=", expr);
}

void CppPrinter::print_division_assignment(DivisionAssignment* expr) {
    print_binary_operator("/=", expr);
}

void CppPrinter::print_bitwise_not_assignment(BitwiseNotAssignment* expr) {
    print_binary_operator("~=", expr);
}

void CppPrinter::print_bitwise_or_assignment(BitwiseOrAssignment* expr) {
    print_binary_operator("|=", expr);
}

void CppPrinter::print_bitwise_xor_assignment(BitwiseXorAssignment* expr) {
    print_binary_operator("^=", expr);
}

void CppPrinter::print_bitwise_and_assignment(BitwiseAndAssignment* expr) {
    print_binary_operator("&=", expr);
}
...
void CppPrinter::print_logical_or(LogicalOr* expr) {
    print_binary_operator("or", expr);
}

void CppPrinter::print_logical_or_oper(LogicalOrOper* expr) {
    print_binary_operator("||", expr);
}

void CppPrinter::print_logical_and(LogicalAnd* expr) {
    print_binary_operator("and", expr);
}

void CppPrinter::print_logical_and_oper(LogicalAndOper* expr) {
    print_binary_operator("&&", expr);
}

void CppPrinter::print_equal(Equal* expr) {
    print_binary_operator("==", expr);
}

void CppPrinter::print_not_equal(NotEqual* expr) {
    print_binary_operator("!=", expr);
}

void CppPrinter::print_less_than(LessThan* expr) {
    print_binary_operator("<", expr);
}

void CppPrinter::print_greater_than(GreaterThan* expr) {
    print_binary_operator(">", expr);
}

void CppPrinter::print_less_than_or_equal(LessThanOrEqual* expr) {
    print_binary_operator("<=", expr);
}

void CppPrinter::print_greater_than_or_equal(GreaterThanOrEqual* expr) {
    print_binary_operator(">=", expr);
}

void CppPrinter::print_in(In* expr) {
    print_binary_operator("in", expr);
}

void CppPrinter::print_not_in(NotIn* expr) {
    print_binary_operator("not in", expr);
}

void CppPrinter::print_inclusive_range(InclusiveRange* expr) {
    print_binary_operator("..", expr);
}

void CppPrinter::print_exclusive_range(ExclusiveRange* expr) {
    print_binary_operator("...", expr);
}

void CppPrinter::print_plus(Plus* expr) {
    print_binary_operator("+", expr);
}

void CppPrinter::print_minus(Minus* expr) {
    print_binary_operator("-", expr);
}

void CppPrinter::print_times(Times* expr) {
    print_binary_operator("*", expr);
}

void CppPrinter::print_division(Division* expr) {
    print_binary_operator("/", expr);
}

void CppPrinter::print_integer_division(IntegerDivision* expr) {
    print_binary_operator("//", expr);
}

void CppPrinter::print_modulo(Modulo* expr) {
    print_binary_operator("%", expr);
}

void CppPrinter::print_power(Power* expr) {
    print_binary_operator("**", expr);
}

void CppPrinter::print_bitwise_or(BitwiseOr* expr) {
    print_binary_operator("|", expr);
}

void CppPrinter::print_bitwise_xor(BitwiseXor* expr) {
    print_binary_operator("^", expr);
}

void CppPrinter::print_bitwise_and(BitwiseAnd* expr) {
    print_binary_operator("&", expr);
}

void CppPrinter::print_shift_left_logical(ShiftLeftLogical* expr) {
    print_binary_operator("<<", expr);
}

void CppPrinter::print_shift_right_logical(ShiftRightLogical* expr) {
    print_binary_operator(">>>", expr);
}

void CppPrinter::print_shift_right_arithmetic(ShiftRightArithmetic* expr) {
    print_binary_operator(">>", expr);
}

void CppPrinter::print_logical_not_oper(LogicalNotOper* expr) {
    print_unary_operator("!", expr);
}

void CppPrinter::print_logical_not(LogicalNot* expr) {
    print_unary_operator("not ", expr);
}

void CppPrinter::print_address_of(AddressOf* expr) {
    print_unary_operator("&", expr);
}

void CppPrinter::print_dereference(Dereference* expr) {
    print_unary_operator("*", expr);
}

void CppPrinter::print_bitwise_not(BitwiseNot* expr) {
    print_unary_operator("~", expr);
}

void CppPrinter::print_unary_minus(UnaryMinus* expr) {
    print_unary_operator("-", expr);
}

void CppPrinter::print_unary_plus(UnaryPlus* expr) {
    print_unary_operator("+", expr);
}

void CppPrinter::print_pre_increment(PreIncrement* expr) {
    print_unary_operator("++", expr);
}

void CppPrinter::print_pre_decrement(PreDecrement* expr) {
    print_unary_operator("--", expr);
}

void CppPrinter::print_pos_increment(PosIncrement* expr) {
    print_unary_operator("++", expr, true);
}

void CppPrinter::print_pos_decrement(PosDecrement* expr) {
    print_unary_operator("--", expr, true);
}
...
void CppPrinter::print_dot(Dot* expr) {
    print_binary_operator(".", expr, true);
}
...
void CppPrinter::print_array(Array* expr) {
    print_expression_list("{", "}", expr->get_expressions());
}

void CppPrinter::print_list(List* expr) {
    print_expression_list("[", "]", expr->get_expressions());
}

void CppPrinter::print_tuple(Tuple* expr) {
   print_expression_list("(", ")", expr->get_expressions());
}

void CppPrinter::print_hash(Hash* expr) {
    print_expression_list("{", "}", expr->get_expressions());
}
...
void CppPrinter::print_binary_operator(const char* oper, BinaryOperator* expr, bool no_spaces) {
    print_expression(expr->get_left());
